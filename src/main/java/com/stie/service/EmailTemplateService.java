...
public class EmailTemplateService {
    ...
    public void seedTemplatesForTenant(com.stie.model.Tenant tenant) {
        try {
            if (tenant == null ? emailTemplateRepository.findAll().stream().noneMatch(t -> t.getTenant() == null) : emailTemplateRepository.findByTenant(tenant).isEmpty()) {
            ...
            // Ignore duplicate key constraints if the templates are already seeded
        }
    }
